...
const btcbamRPC_1 = require("./btcbamRPC");
describe("Contract", () => {
    ...
    it("creates a contract", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield btcbamRPC_1.generateBlock(network);
        });
    });
    let contractAddress;
    ...
    it("invokes contractCall", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield wallet.contractCall(contractAddress, encodedData, wallet.address);
    ...
    it("invokes contractSend", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield btcbamRPC_1.generateBlock(network);
            yield time_1.sleep(1000);
            const result = yield wallet.contractCall(contractAddress, "6d4ce63c", wallet.address);
            const executionResult = result.executionResult;
