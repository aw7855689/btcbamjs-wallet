...
class WalletRPCProvider {
    ...
    rawCall(method, params = [], opts = {}) {
        ...
        switch (method.toLowerCase()) {
            ...
            case "callcontract":
                return this.wallet.contractCall(contractAddress, encodedData, Sweb3_1.Encoder.addressToHex(this.wallet.address).substring(24), opts);
            default:
