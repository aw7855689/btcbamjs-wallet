...
const btcbamd_rpc_1 = __importDefault(require("btcbamd-rpc"));
const Network_1 = require("./Network");
class BtcbamRPC {
    constructor(config) {
        this.rpc = new btcbamd_rpc_1.default(config);
    }
    generate(nblocks) {
...
exports.default = BtcbamRPC;
exports.rpcClient = new BtcbamRPC({
    user: "btcbam",
    pass: "test",
    port: "18332",
    protocol: "http",
...
//# sourceMappingURL=btcbamRPC.js.map