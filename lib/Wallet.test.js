...
describe("Wallet", () => {
    ...
    it("sends payment to a receiving address", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            chai_1.assert.equal(senderOldInfo.balance - senderNewInfo.balance, Math.round(1.009 * 1e7), "sender");
            chai_1.assert.equal(receiverNewInfo.balance - receiverOldInfo.balance, 1e7, "receiver");
        });
    });
});
