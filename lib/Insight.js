...
class Insight {
    ...
    sendRawTx(rawtx) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield axios_1.default.post("https://explorer.sbercoin.com/api/tx/send", {
                rawtx,
    ...
    estimateFee(nblocks = 6) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield axios_1.default.get('https://explorer.sbercoin.com/api/info').then(function (response) {
