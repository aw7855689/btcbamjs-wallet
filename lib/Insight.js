...
const INSIGHT_BASEURLS = {
    [constants_1.NetworkNames.MAINNET]: "https://insight-api.sbercoin.com",
...
class Insight {
    constructor(baseURL) {
        ...
        this.axios1 = axios_1.default.create({
            NewApiExplorer: "https://explorer.sbercoin.com/api",
        });
    }
    ...
    sendRawTx(rawtx) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.axios1.post("/tx/send", {
                rawtx,
            });
            return res.data; 
        });
    ...
    estimateFee(nblocks = 6) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield axios.get('https://explorer.sbercoin.com/api/info').then(function (response) {
