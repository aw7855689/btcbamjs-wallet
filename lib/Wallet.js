...
class Wallet {
     ...
     * @param opts
     */
    contractCall(contractAddress, encodedData, sender, opts = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getBitcoinjsUTXOs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bitcoinjsUTXOs = uxtos.map((uxto) => (Object.assign(Object.assign({}, uxto), { pos: uxto.outputIndex, value: uxto.value, hash: uxto.transactionId }))).filter((utxo) => utxo.confirmations >= 500 || !utxo.isStake);
